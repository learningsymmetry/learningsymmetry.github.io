...
author:
  - name: Carles Gelada, Jacob Buckman
    url: learningsymmetry.github.io
date: 12-10-2022
output:
...
\footnote{For simplicity, we discuss only vanilla full-batch gradient descent. In practice it is more common to use variants such as SGD, momentum, Adam, etc.}
...
\footnote{Outside of limiting cases with specialized parameterizations, such as [NTK](https://en.wikipedia.org/wiki/Neural_tangent_kernel).}
